...
TestStrFindStr()
{
  ...
  printf("\nTest6:\n");
  res1 = StrFindStr(str3, "shouldaa");
  res2 = strstr(str3, "shouldaa");
  ...
  printf("\nTest8:\n");
  char str4[] = "bcbca";
  res1 = StrFindStr(str4, "bca");
  res2 = strstr(str4, "bca");
  PRINT_RESULT((strcmp(res1, res2) == 0));
  printf("Your     Answer: [%s]\n", res1);
  printf("String.h Answer: [%s]\n", res2);
  ...
  printf("\nTest12:\n");
  char str7[] = "bbbcabbca";
  res1 = StrFindStr(str7, "bbca");
  res2 = strstr(str7, "bbca");
  PRINT_RESULT((strcmp(res1, res2) == 0));
  printf("Your     Answer: [%s]\n", res1);
  printf("String.h Answer: [%s]\n", res2);
...
TestStrCompare()
{
  ...
  printf("\nTest7:\n");
  res1 = StrCompare("a\203", "a\003");
  res2 = strcmp("a\203", "a\003");
  printf("Your     Answer: [%d]\n", res1);
  printf("String.h Answer: [%d]\n", res2);
...
TestStrToLong()
{
  ...
  char* str9 = malloc(10*sizeof(char));
  printf("Test10:\n");
  strcpy(str9, "-123");
  res1 = StrToLong(str9, NULL, 10);
  res2 = strtol(str9, NULL, 10);
  PRINT_RESULT(res1 == res2);
  printf("Your      Answer: [%ld]\n", res1);
  printf("String.h  Answer: [%ld]\n", res2);
  ...
  printf("Test15:\n");
  strcpy(str9, "  a ");
  res1 = StrToLong(str9, &end1, 10);
  res2 = strtol(str9, &end2, 10);
  PRINT_RESULT((res1 == res2) && (end1 == end2));
  printf("Your      Answer: [%ld]\n", res1);
  printf("String.h  Answer: [%ld]\n", res2);
  printf("Your      Answer: [%s]\n", end1);
